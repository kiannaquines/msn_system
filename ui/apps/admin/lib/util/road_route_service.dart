...
class RoadRouteService {
  ...
  Future<List<LatLng>> getRoutePoints({
    ...
    // 1. Try Mapbox Directions API with alternatives=true to find shortest / most optimized path
    ...
    // 2. Try OpenStreetMap / OSRM routing API fallback with shortest route selection
    try {
